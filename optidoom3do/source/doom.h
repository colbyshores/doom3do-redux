...
#define SCREENSIZE_OPTIONS_NUM 6    // Number of screen size options
...
extern Word ScreenSizeOption;	/* Screen size to use */
...
extern Word ScreenWidthPhysical;	/* True Width of the view screen (after screen scale, excluding fit to screen)*/
extern Word ScreenHeightPhysical;	/* True Height of the view screen (after screen scale, excluding fit to screen)*/
...
// Placed at the end to make some structs visible (like player_t) to the externed functions
#include "doomx.h"
