...
Foo	SETA	280/4
	WHILE	Foo/=0
	AND      v4,v1,a3,LSR #22		;v4 = p1 y-index (4 bits from pos 22-25)
	ORR      v4,v4,a2,LSR #28		;v4 = p1 xy-index (4 bits from pos 28-31)
	ADD      a2,a2,a4				;step xfrac to p2
	ADD      a3,a3,v2				;step yfrac to p2

	AND      ip,v1,a3,LSR #22		;ip = p2 y-index
	ORR      ip,ip,a2,LSR #28		;ip = p2 xy-index
